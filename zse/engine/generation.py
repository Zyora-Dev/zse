...
from typing import Optional, Dict, List, Tuple, Any, Iterator, AsyncIterator, Callable, Union
...
class Sampler:
    ...
    def sample(
        ...
        if generated_tokens and (
            self.params.frequency_penalty != 0 or self.params.presence_penalty != 0
        ):
